    ...
    <div class="w-75 mx-auto">
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                ...
                @if($check_room->status_check != 'รอการซ่อม')
                <tr>
                    <td>{{ $i + 1 }}</td>
                    <td>{{ $check_room->name_room }}</td>
                    <td hidden><input type="text" name="id_check_room" value="{{ $check_room->id_checkroom }}">
                    </td>
                    ...
                    <td><a href="{{ route('detail_check', $check_room->id_checkroom) }}" class="btn btn-success">รายละเอียด</a></td>
                </tr>
                @endif
                @endforeach
            </tbody>
